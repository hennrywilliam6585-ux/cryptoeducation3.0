...
const AdminLogin: React.FC = () => {
    ...
    const { adminLogin, systemSettings } = useAuth();
            ...
            <div className="w-full max-w-md">
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg shadow-2xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400">Welcome to {systemSettings.siteTitle || 'Crypto Education'} Admin Panel</p>
                    </div>
                    ...
                    <div className="text-center mt-6 space-y-2">
                        <p className="text-sm text-gray-400">
                            Not an Admin? <Link to="/login" className="text-accent/80 hover:underline hover:text-accent">User Login</Link>
                        </p>
                    </div>
                </div>
            </div>
